...
export default async function handler(req, res) {
    if(req.method == "POST"){
        ...
        if(rooms_with_same_name.length > 0){
            ...
            var doc = { _type:"room",name,creator:{ _type:"reference",_ref:user_info.user_id },admin:{ _type:"reference",_ref:user_info.user_id },members:[{ _type:"reference",_ref:member._id }]};
